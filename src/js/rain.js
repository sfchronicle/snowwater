...
// Parse the date / time
var parseFullDate = d3.time.format("%m/%Y").parse;
...
x.domain([parseFullDate('10/2015'), parseFullDate('09/2016')]);
y.domain([0,90]);
...
var lineSWC = d3.svg.line()
    ...
    .x(function(d) {
      ...
      if (datetemp[0] >= 10) {
        var datetemp2 = datetemp[0]+"/2015";
      } else {
        var datetemp2 = datetemp[0]+"/2016";
      }
      // var datetemp2 = datetemp[0]+"/"+datetemp[1]+"/"+d.Year;
      return x(parseFullDate(datetemp2));
    })
    .y(function(d) {
      return y(d.cumulativeWater);
    });
...
snowwaterData.forEach(function(d,idx){
  ...
  if (datetemp[0] >= 10) {
    var datetemp3 = datetemp[0]+"/2015";
  } else {
    var datetemp3 = datetemp[0]+"/2016";
  }
  ...
  flatData.push(
    {key: d.waterYear, SWC: d.cumulativeWater, Date: datetemp3, DateString: d.Date}
  );
});
...
nodes.append("text")
    ...
    .text(function(d) {
        if (d.key == "2017" && d.DateString == "1/2017"){
